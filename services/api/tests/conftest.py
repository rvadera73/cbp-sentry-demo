...
def greenfield_referral_package(greenfield_manifest, greenfield_entities, greenfield_score_breakdown):
    ...
    return {
        ...
        "sections": {
            ...
            "import_pattern": [
                {"month": "2025-11", "shipments": 1, "weight_kg": 18500, "declared_origin": "MY", "unit_value": 2.15},
                {"month": "2025-12", "shipments": 2, "weight_kg": 41200, "declared_origin": "TH", "unit_value": 2.22},
                {"month": "2026-01", "shipments": 2, "weight_kg": 39800, "declared_origin": "VN", "unit_value": 2.35},
                {"month": "2026-02", "shipments": 3, "weight_kg": 62900, "declared_origin": "VN", "unit_value": 2.41},
                {"month": "2026-03", "shipments": 4, "weight_kg": 88100, "declared_origin": "VN", "unit_value": 2.37},
                {"month": "2026-04", "shipments": 1, "weight_kg": 26200, "declared_origin": "VN", "unit_value": 2.48},
            ],
            "trade_flow": {
                "hts_code": "7604.10.1000",
                "ad_cvd_status": "ACTIVE",
            ...
            "document_review": [
                ...
                {"type": "Commercial Invoice", "filed_date": "2026-04-14", "origin_declared": "Vietnam"},
                {"type": "ISF Filing", "filed_date": "2026-05-23", "element_9": "China", "status": "MISMATCH"},
            ],
            "document_consistency": [
                ...
                {"issue": "Price below market", "type": "HIGH", "evidence": "Declared $2.48/kg vs market $3.05/kg"},
                {
            ...
            "data_sources": [
                {"name": "CBP Manifest Filing", "confidence": 0.95, "data_element": "Shipper, consignee, HTS, value"},
                {"name": "ISF Data Element 9", "confidence": 0.99, "data_element": "Container stuffing location"},
                {"name": "AIS vessel tracking", "confidence": 0.92, "data_element": "Port dwell times"},
                {"name": "Senzing entity resolution", "confidence": 0.98, "data_element": "Entity linkage"},
                {"name": "AD/CVD Proceedings", "confidence": 0.99, "data_element": "Tariff rates"},
                {"name": "Corporate Registry (Vietnam)", "confidence": 0.94, "data_element": "Shipper registration"},
                {"name": "Corporate Registry (Hong Kong)", "confidence": 0.91, "data_element": "Holding company"},
                {"name": "Corporate Registry (China SAMR)", "confidence": 0.98, "data_element": "Manufacturer details"},
                {"name": "Trade History (Panjiva)", "confidence": 0.87, "data_element": "Prior patterns"},
            ],
        },
    }
