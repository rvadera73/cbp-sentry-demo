...
class ComtradeAdapter(BaseAPIAdapter):
    ...
    def fetch_fixture(self, hs_code: str, reporter: str, partner: str, year: int = 2024) -> Dict[str, Any]:
        """Return fixture trade data with strategic case adjustments for demo"""
        # Benchmark prices for common HS codes
        benchmarks = {
            "7604": {  # Aluminum extrusions
                "unit_price_per_kg": 10.00,  # Increased to trigger undervaluation when declared < $10/kg
                "avg_shipment_kg": 15000,
                "annual_volume": 5000000,
                "flag": "PRICE_BELOW_MARKET" if reporter == "VN" and partner == "US" else None,
            },
            "8541": {  # Solar modules (high AD/CVD)
                "unit_price_per_kg": 12.00,  # Higher benchmark to trigger pricing flags
                "avg_shipment_kg": 10000,
                "annual_volume": 3000000,
                "flag": None,
            },
            "7610": {  # Aluminum bars (low-risk)
            ...
            "7611": {  # Aluminum tubes
                "unit_price_per_kg": 7.50,
                "avg_shipment_kg": 8000,
...
class ITCTariffsAdapter(BaseAPIAdapter):
    ...
    def fetch_fixture(self, hs_code: str, origin_country: str = None) -> Dict[str, Any]:
        """Return fixture tariff data with AD/CVD rates - includes high duties for risk scoring"""
        ...
        duty_fixtures = {
            ...
            "7610": {  # Aluminum bars (no active AD/CVD)
                "CN": {"base_rate": 0.06, "ad_cv_rate": 0.00, "total": 0.06, "case": "No duties"},
                "VN": {"base_rate": 0.06, "ad_cv_rate": 0.00, "total": 0.06, "case": "No duties"},
                "MY": {"base_rate": 0.06, "ad_cv_rate": 0.00, "total": 0.06, "case": "No duties"},
                "TH": {"base_rate": 0.06, "ad_cv_rate": 0.00, "total": 0.06, "case": "No duties"},
            },
            "7611": {  # Aluminum tubes
                "CN": {"base_rate": 0.06, "ad_cv_rate": 0.00, "total": 0.06, "case": "No duties"},
                "VN": {"base_rate": 0.06, "ad_cv_rate": 0.00, "total": 0.06, "case": "No duties"},
            ...
            "8541": {  # Solar modules
                "CN": {"base_rate": 0.00, "ad_cv_rate": 1.00, "total": 1.00, "case": "CVD from China (ITC cases)"},
                "VN": {"base_rate": 0.00, "ad_cv_rate": 1.00, "total": 1.00, "case": "Transshipment from China"},
                "MY": {"base_rate": 0.00, "ad_cv_rate": 1.00, "total": 1.00, "case": "CVD from Malaysia"},
                "TH": {"base_rate": 0.00, "ad_cv_rate": 1.00, "total": 1.00, "case": "CVD from Thailand"},
            },
            "8517": {  # Electronics (low risk)
                "CN": {"base_rate": 0.00, "ad_cv_rate": 0.00, "total": 0.00, "case": "No duties"},
                "VN": {"base_rate": 0.00, "ad_cv_rate": 0.00, "total": 0.00, "case": "No duties"},
                "SG": {"base_rate": 0.00, "ad_cv_rate": 0.00, "total": 0.00, "case": "No duties"},
            },
        }
