...
_SEED_SOURCES: List[tuple] = [
    ...
    (
        ...
        "online",
        "monthly",
        "cbp.gov EAPA notices via Wayback + PDF harvest",
        "Real EAPA cases + determination-PDF entities/relationships (94 cases, 227 entities, 417 edges).",
        "cbp.gov Akamai-blocks server IPs; sourced via Wayback + direct PDF fetch.",
    ),
    (
        "gleif",
        "Entity registry — GLEIF (LEI)",
        "entity",
        "online",
        "monthly",
        "api.gleif.org",
        "Resolves EAPA entities to LEI, registered address, and parent/child ownership (affiliates).",
        "Covers LEI-holders only (larger/international); small private importers unmatched.",
    ),
    (
        "opencorporates",
        "Entity registry — OpenCorporates",
        "entity",
        "online",
        "monthly",
        "api.opencorporates.com",
        "US state-registry company #, incorporation date (entity age), officers, address.",
        "Requires a free OC_API_TOKEN (not set); activates when provided.",
    ),
    (
        "sec-edgar",
        "Entity registry — SEC EDGAR",
        "entity",
        "online",
        "monthly",
        "sec.gov/edgar",
        "Public-company CIK, officers, subsidiaries.",
        "Covers SEC public filers only; most EAPA importers are private.",
    ),
]
