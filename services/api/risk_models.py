...
class RiskModelConfig:
    ...
    COMMODITY_RISK = {
        ...
        'sensitivity_matrix': {
            ...
            'aluminum_extrusions': {'base_risk': 7.0, 'export_control': False, 'commodity_code': ['7604', '7610'], 'ad_cvd_rate': 150},
            'solar_equipment': {'base_risk': 7.5, 'export_control': False, 'commodity_code': ['8501', '8517'], 'uflpa_risk': True},
